...
function initMap(vehicleData) {
  ...
  vehicleData.forEach(function (xe) {
    ...
    var statusConfig = {
      ...
      icon: icons.green,
      btnText: "THUÊ NGAY",
      btnColor: "#28a745", // Xanh lá
      isBookable: true, // ✅ Được bấm
    ...
    if (statusNormal === "maintenance" || statusNormal === "bao tri") {
      ...
      statusConfig = {
        ...
        btnColor: "#dc3545",
        isBookable: false, // ⛔ KHÓA TƯƠNG TÁC
        bookingAction: null,
      ...
      // Logic tính giờ trả xe giả định (cho sinh động)
      ...
      statusConfig = {
        ...
        icon: icons.blue,
        btnText: "ĐẶT LỊCH",
        btnColor: "#007bff", // Xanh dương
        isBookable: true, // ✅ Vẫn được bấm để đặt lịch sau
      ...
      statusConfig = {
        ...
        btnColor: "#e0a800", // Vàng đậm
        isBookable: true, // ✅ Vẫn được bấm
    ...
    // Kết quả sẽ là: /thue-xe/1/?action=book_later
...
// ===================================
// 4. TÍNH TOÁN LỘ TRÌNH & DỊCH THUẬT
// ===================================
...
// 4. Xử lý đóng khi click ra ngoài
